...
async def carbon_api(e):
 if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
   ...
   await e.edit("**Completato...\n100%**")
   file = './carbon.png'
   await e.edit("**Uploading...**")
   await e.client.send_file(
         e.chat_id,
         file,
         caption="**Ecco il tuo carbon!** \n**Schema Colore: **`{}`".format(color_name),
         force_document=True,
