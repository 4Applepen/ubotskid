...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`Invalido gruppo`")
            return None
        except ChannelPrivateError:
            await event.edit("`questo gruppo/canale è privato, oppure io sono bannato.`")
            return None
        except ChannelPublicGroupNaError:
            await event.edit("`Inesistente`")
            return None
